...
namespace Runtime.StateMachine.Debugging
{
	/// <summary>
	...
	internal class StateMachineDebugger
	{
		...
		private Runtime.StateMachine.Core.StateMachine _stateMachine;
		...
		/// </summary>
		internal void Awake(Runtime.StateMachine.Core.StateMachine stateMachine)
		{
