...
namespace Runtime.StateMachine.ScriptableObjects
{
	public abstract class StateConditionSO : ScriptableObject
	{
		...
		/// </summary>
		internal StateCondition GetCondition(Runtime.StateMachine.Core.StateMachine stateMachine, bool expectedResult, Dictionary<ScriptableObject, object> createdInstances)
		{
