...
namespace Runtime.StateMachine.ScriptableObjects
{
	...
	public class StateSO : ScriptableObject
	{
		...
		/// </summary>
		internal State GetState(Runtime.StateMachine.Core.StateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
		{
		...
		private static StateAction[] GetActions(StateActionSO[] scriptableActions,
			Runtime.StateMachine.Core.StateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
		{
